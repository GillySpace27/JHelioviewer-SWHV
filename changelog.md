...
- Add a `Track CME` action to CACTus event dialogs that animates the RadialWarp exponent so the CME front stays at a fixed screen radius through the movie
