...
public class GLImage {
    ...
    // Radial mask as fractions of the layer's outer radius: the band [innerMask, outerMask]
    // is shown. innerMask = 0 and outerMask = 1 mask nothing; they meeting masks everything.
    ...
    public void applyFilters(boolean rhefActive) {
        ...
        // be Float.MAX_VALUE (unbounded FOV, e.g. AIA); the corner distance (radial) overshoots
        // the circular FOV, so inscribed is the meaningful full-extent reference.
