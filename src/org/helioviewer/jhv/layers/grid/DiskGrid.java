...
public final class DiskGrid {
    ...
    private static final double SPOKE_STEP_DEGREES = 30;
    ...
    private void updateLine(MapScale scale, double[] rings) {
        int spokes = (int) Math.round(360 / SPOKE_STEP_DEGREES);
        ...
        for (int s = 0; s < spokes; s++) {
            double a = Math.toRadians(s * SPOKE_STEP_DEGREES);
